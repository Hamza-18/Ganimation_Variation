...
# input_nc = input channels of the image
# ouput_nc = output channels for the image
...
class SplitGenerator(nn.Module):
    ...
    def forward(self, img, au):
        ...
        return self.color_top(embed_features), self.au_top(embed_features), embed_features # return the output
