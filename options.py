...
class Options(object):
    ...
    def initialize(self):
        ...
        parser.add_argument('--pose_pkl', type=str, default="pose_aus.pkl", help='Pose pickle dictionary.')
        ...
        parser.add_argument('--pose_nc', type=int, default=17, help='pose number of channel')
